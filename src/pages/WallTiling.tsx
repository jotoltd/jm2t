...
import { GalleryRow1 } from '../components/ImageGallery';
    ...
    <div className="min-h-screen bg-neutral-950 font-sans text-neutral-100">
      ...
      <section className="relative bg-[#050507] pt-32 pb-20 border-b border-white/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            Wall <span className="text-transparent bg-clip-text bg-gradient-to-b from-cyan-300 to-cyan-500">Tiling</span>
          </motion.h1>
          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-12">
            <div className="space-y-6 text-neutral-300 text-base leading-relaxed">
              <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                At JM²TilingCo, we offer professional wall tiling services designed to enhance the appearance, durability, and value of your home or commercial space. Whether you're updating a kitchen splashback, renovating a bathroom, or creating a bespoke feature wall, we deliver high-quality finishes with precision and attention to detail.
              </motion.p>
              <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }}>
                We work with a wide range of tile materials including porcelain, ceramic, and natural stone, installing everything from clean contemporary layouts to more detailed decorative patterns. Every project is carefully prepared and completed to ensure a flawless finish that is both visually impressive and built to last.
              </motion.p>
              <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
                At JM²TilingCo, customer satisfaction and quality workmanship are at the centre of everything we do. We take pride in delivering expertly tiled walls that combine durability, precision, and modern design to transform any space.
              </motion.p>
              <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="text-cyan-400 font-bold">
                Get in touch today for a free quotation and let us help bring your vision to life with professional wall tiling solutions.
              </motion.p>
            </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="bg-neutral-900 border-2 border-cyan-500/30 p-6 self-start">
              <p className="text-cyan-400 font-mono text-[10px] uppercase tracking-widest mb-2">Pricing Guide</p>
              <p className="font-display text-4xl font-black text-white">£50 – £60</p>
              <p className="text-neutral-400 text-sm mt-1">per m²</p>
              ...
              <a href="#contact" className="mt-6 w-full block text-center bg-cyan-500 hover:bg-cyan-400 text-black font-black uppercase tracking-widest py-3 text-sm transition-all shadow-[0_0_20px_rgba(77,238,255,0.3)]">
                Get Free Quote
              </a>
            </motion.div>
          </div>
