    ...
    <div className="min-h-screen bg-neutral-950 font-sans text-neutral-100">
      ...
      <section className="relative bg-[#050507] pt-32 pb-20 border-b border-white/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            Floor <span className="text-transparent bg-clip-text bg-gradient-to-b from-cyan-300 to-cyan-500">Tiling</span>
          </motion.h1>
          <motion.p
          ...
          <div className="grid md:grid-cols-[2fr_1fr] gap-12">
            ...
            <div className="space-y-6 text-neutral-300 text-base leading-relaxed">
              <motion.p
                ...
                viewport={{ once: true }}
              >
                At JM²TilingCo, we specialise in high-quality floor tiling solutions designed to elevate both residential and commercial spaces across Surrey and West Sussex. Whether you're renovating a bathroom, upgrading a kitchen, or transforming an entire property, we deliver precise workmanship with a clean, professional finish every time.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <motion.p
                ...
                transition={{ delay: 0.2 }}
              >
                At JM²TilingCo, we pride ourselves on reliability, precision, and customer satisfaction — delivering stunning tiled floors that not only look exceptional but are built to stand the test of time.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 10 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                Get in touch today for a free quotation and let us help bring your project to life.
              </motion.p>
            </div>
            ...
            >
              ...
              <p className="font-display text-4xl font-black text-white">£80 – £95</p>
